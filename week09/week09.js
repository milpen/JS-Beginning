...
console.log(1,'Нужно бежать со всех ног, чтобы только оставаться на месте, а чтобы куда-то попасть, надо бежать как минимум вдвое быстрее!');
...
let myName = "Мила";
console.log(4,"Добро " + "пожаловать, " + myName);
...
let totalSum = 128 + 254 + 137 + 201;
let hours = totalSum/60;
console.log(7, hours);
//Задание 9
...
console.log(8, cleanerSalary + teacherSalary + ' рублей');
//Задание 10
...
console.log(10, `${fahrenheit}` + ' градуса по Фаренгейту — это ' + `${celsius}` + ' градуса по Цельсию.');
//Задание 12
